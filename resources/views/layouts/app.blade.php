        ...
        <div class="sidebar-wrapper active">
            <div class="sidebar-header position-relative">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="logo">
                        <a href="{{route('parent_category.index')}}"><img src="{{asset('panel/assets/images/logo/logo.svg')}}" alt="Logo" srcset=""></a>
                    </div>
            ...
            <div class="sidebar-menu">
                <ul class="menu">
                    ...
                    <li
                        class="sidebar-item">
                        <a href="{{route('parent_category.index')}}" class='sidebar-link'>
                            <i class="bi bi-grid-fill"></i>
        ...
        <footer>
            <div class="footer clearfix mb-0 text-muted">
                <div class="float-start">
                    <p>{{date('Y')}} &copy; firatcelkal@gmail.com</p>
                </div>
